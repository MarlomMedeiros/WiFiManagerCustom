...
const char * const HTTP_PORTAL_MENU[] PROGMEM = {
  ...
  "<form action='/0wifi'   method='get'><button>Configurar WiFi (Sem escaneamento)</button></form><br/>\n", // MENU_WIFINOSCAN
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Salvando Credenciais<br/>Tentando conectar o ESP à rede.<br />Se falhar, reconecte ao AP para tentar novamente.</div>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Conectado</strong> em {v}<br/><em><small>com IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Não conectado</strong> em {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>Falha na autenticação"; // STATION_WRONG_PASSWORD, no esp32
...
const char HTTP_UPDATE_SUCCESS[] PROGMEM = "<div class='msg S'><strong>Atualização bem-sucedida.  </strong><br/>O dispositivo está reiniciando...</div>";
...
// @todo remove html elements from progmem, repetetive strings
  ...
  const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Último motivo de reinicialização</dt><dd>CPU0: {1}<br/>CPU1: {2}</dd>";
  ...
  const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Último motivo de reinicialização</dt><dd>{1}</dd>";
...
const char HTTP_INFO_uptime[]     PROGMEM = "<dt>Tempo de atividade</dt><dd>{1} min {2} seg</dd>";
...
const char S_nonetworks[]         PROGMEM = "Nenhuma rede encontrada. Atualize para pesquisar novamente.";
...
const char S_closing[]            PROGMEM = "Você pode fechar a página, o portal continuará em execução";
